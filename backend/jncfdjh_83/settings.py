"""
Django settings for jncfdjh_83 project.
...
WSGI_APPLICATION = 'jncfdjh_83.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jncfdjh_83 API",
    "DESCRIPTION": "API documentation for jncfdjh_83 App",
    "VERSION": "v1",
}
